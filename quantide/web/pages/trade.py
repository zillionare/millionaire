    ...
    return Div(
        Div(
            ...
            Form(
                Div(
                    Div(
                        _Label("账户名称", cls="text-sm font-medium whitespace-nowrap"),
                        Input(name="name", placeholder="例如: 策略A",
                              cls="uk-input uk-form-small rounded-md flex-1 min-w-0",
                              required=True),
                        cls="flex items-center gap-2 flex-1",
                    ),
                    Div(
                        _Label("初始资金", cls="text-sm font-medium whitespace-nowrap"),
                        Input(name="principal", type="number", value="1000000",
                              cls="uk-input uk-form-small rounded-md flex-1 min-w-0"),
                        cls="flex items-center gap-2 flex-1",
                    ),
                    cls="flex gap-4 mb-3",
                ...
                Div(
                    Div(
                        _Label("佣金费率", cls="text-sm font-medium whitespace-nowrap"),
                        Input(name="commission", type="number", step="0.0001",
                              value="0.0001",
                              cls="uk-input uk-form-small rounded-md flex-1 min-w-0"),
                        cls="flex items-center gap-2 flex-1",
                    ),
                    Div(
                        _Label("市值更新 (秒)", cls="text-sm font-medium whitespace-nowrap"),
                        _Select(
                            Option("3 秒", value="3"),
                            Option("5 秒", value="5"),
                            Option("10 秒 (推荐)", value="10", selected=True),
                            cls="uk-select uk-form-small rounded-md flex-1 min-w-0",
                ...
                Div(
                    _Label("描述信息", cls="text-sm font-medium mb-1"),
                    Textarea(
                        name="info",
                        placeholder="账户描述（可选）",
                        cls="uk-textarea uk-form-small rounded-md w-full",
                        rows=2,
                    ),
                    cls="mb-4",
                ),
                Div(
                    Button("取消", type="button", cls="uk-button uk-button-default",
                           onclick="document.getElementById('create-modal').innerHTML = ''"),
                    Button("创建", type="submit", cls="uk-button uk-button-primary ml-2",
                           style="background-color: #d32f2f;"),
