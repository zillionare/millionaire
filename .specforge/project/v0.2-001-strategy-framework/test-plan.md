...
| FR-011 | AC-011-01 ~ 04 | 回测端点 + 账户端点 + 委托/成交 DB | §2.2 撮合 + §2.3 回测 + §2.4 指标 |
| FR-012 | AC-012-01 ~ 04 | 同 FR-011 + 30m 数据 + 类型拒绝日志 | §2.2 + §2.3 |
| FR-013 | AC-013-01 ~ 05 | 风控事件 DB + 超额收益 DB + tick 日志 | §2.5 风控 |
...
- FR-010 / FR-011 / FR-012 / FR-013 / FR-014 / FR-015 / FR-020 的所有 AC
