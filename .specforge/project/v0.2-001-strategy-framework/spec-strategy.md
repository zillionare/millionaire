...
> **AC**: 无（行为由 [test-plan.md §5.4.5](./test-plan.md) L1 paper E2E 覆盖）
...
> **AC**: 无（行为由 [test-plan.md §5.4.5](./test-plan.md) L1 paper E2E 覆盖；具体 AC 在域 1 Commit B 集中补 FR-030/FR-040）
...
> **AC**: 无（行为由 [test-plan.md §1.5 三种下单方式表 + §5.4 L1 paper E2E](./test-plan.md) 覆盖）
...
> **AC 覆盖**: 行为由 [test-plan.md §5.4.1 / §5.4.5](./test-plan.md) L1 paper E2E 覆盖，AC 在域 2 (FR-090/100/110) 集中补齐时引用本 FR.
>
