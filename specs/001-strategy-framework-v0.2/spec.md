...
- **用户策略**:`BaseStrategy`(FR-010)的所有子类(含 `DayStrategy` / `LiveStrategy` / `RiskStrategy`)
...
| `strategy_type` | `Literal["day", "live", "risk"]` | 由最终基类(DayStrategy/LiveStrategy/RiskStrategy)推导 | 用于调度路由(联动 FR-115/120/125) |
...
> **已迁移到 [002-ui-v0.2/spec.md UI-FR-260](../002-ui-v0.2/spec.md)**。调度规则在 001-FR-230/240/250;UI 操作定义在 UI-FR-040。
...
- 盘前获取当日涨跌停价格与复权因子
- 定时任务可配置;运行有报告跟踪;**错误展示已迁移到 [002-ui-v0.2/spec.md UI-FR-310-UI](../002-ui-v0.2/spec.md)**
- 任务错过执行(错误纠正后)可重新执行
- 支持数据补录
...
后台任务定时执行数据完整性校验(缺日、重复日、字段空值率等);**报告展示已迁移到 [002-ui-v0.2/spec.md UI-FR-320-UI](../002-ui-v0.2/spec.md)**。
...
- 支持用户查询个股历史行情;**K 线图绘制已迁移到 [002-ui-v0.2/spec.md UI-FR-330-UI](../002-ui-v0.2/spec.md)**
...
> **已迁移到 [002-ui-v0.2/spec.md UI-FR-370](../002-ui-v0.2/spec.md)**。

---

### FR-380 可视化 — 回测进度

> **已迁移到 [002-ui-v0.2/spec.md UI-FR-380 / UI-FR-080](../002-ui-v0.2/spec.md)**。

---

### FR-390 账户总览（多策略维度）

> **已迁移到 [002-ui-v0.2/spec.md UI-FR-390](../002-ui-v0.2/spec.md)**。

---

### FR-400 委托与成交记录

> **已迁移到 [002-ui-v0.2/spec.md UI-FR-400](../002-ui-v0.2/spec.md)**。

---

### FR-410 paper/live 账户

> **已迁移到 [002-ui-v0.2/spec.md UI-FR-410](../002-ui-v0.2/spec.md)**。

---

### FR-420 实盘交易界面

> **已迁移到 [002-ui-v0.2/spec.md UI-FR-420](../002-ui-v0.2/spec.md)**。

---

### FR-430 仿真交易界面

> **已迁移到 [002-ui-v0.2/spec.md UI-FR-430](../002-ui-v0.2/spec.md)**。
...
> **行为定义在本 FR;UI 表现已迁移到 [002-ui-v0.2/spec.md UI-FR-060](../002-ui-v0.2/spec.md)**。
...
> **通知配置 UI 已迁移到 [002-ui-v0.2/spec.md UI-FR-450](../002-ui-v0.2/spec.md)**。本 FR 仅定义**触发事件**。
...
> **已迁移到 [002-ui-v0.2/spec.md UI-FR-460](../002-ui-v0.2/spec.md)**。
...
- 002-ui-v0.2 — UI 渲染的可观测性另由 UI spec 覆盖
...
> - **新建 [002-ui-v0.2/spec.md](../002-ui-v0.2/spec.md)**:抽出全部 UI 相关 FR(原 260/370/380/390/400/410/420/430/450/460),补齐缺失(策略发现 UI-FR-010、运行时参数编辑 UI-FR-020、调度操作 UI-FR-040、dry-run 视图 UI-FR-060、风控事件可视化 UI-FR-070、回测进度 UI-FR-080)。FR-310/320/330 按"业务规则留 001 + UI 展示入 002"拆分
